...
function App() {
    ...
    useEffect(() => {
        const url = 'https://calendarific.com/api/v2/holidays?country=IN&year=2019&api_key=2e3b6f568fe3cd7da7bdb937d45613ad41c3f347&amp';
        fetch(url)
            .then(res => res.json())
            .then((result) => {
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <div className="btn-group btn-group-lg" role='group' aria-label='btn-grp1' style={st}>
                            ...
                            <button type="button" className={!mode ? "btn btn-outline-primary" : "btn btn-outline-primary active"}
